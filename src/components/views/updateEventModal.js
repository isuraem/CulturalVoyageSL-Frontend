...
import {  updateEventsService } from "../services/eventService";
...
const UpdateEventModal = (props) => {
    ...
    const [eventDescription, seteventDescription] = useState(props.data.eventDescription);
    ...
    const [Performer, setPerformer] = useState(props.data.Performer);
    ...
    const [imageOne, setimageOne] = useState(props.data.imageOne);
    const [imageTwo, setimageTwo] = useState(props.data.imageTwo);
    const [imageThree, setimageThree] = useState(props.data.imageThree);
    const [Agenda, setAgenda] = useState(props.data.Agenda);
    ...
    const onSubmit = async () => {
        ...
        let response = await updateEventsService(event);
